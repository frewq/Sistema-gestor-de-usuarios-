...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    public InformacionUsuario() {
        ...
        jLabel_Wallpaper.setText("Información del usuario " + user_update);
        ...
        try {
            ...
            System.out.println("Error en cargar usuario." + er);
    ...
    private void jButton_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_actualizarActionPerformed
        ...
        if (validacion == 0) {
            ...
            try {
                Connection cn = Coneccion.conectar();
                PreparedStatement pst = cn.prepareStatement("select username from usuarios where username = '" + username + "' and not id_usuario = '" + ID + "'"); //consulta todos los usuarios, excepto el que consulta
                ...
                System.err.println("Error al actualizar: " +er);
            }
